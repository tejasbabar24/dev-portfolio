            ...
            <div className="md:col-span-7 col-span-12 row-span-5">
              <div className="bg-black-300 rounded-2xl p-7 h-full w-full">
                ...
                <div className=" mt-5">
                  ...
                  <p className=" md:text-2xl  mt-2 text-justify">
                    Computer Engineer | Web Developer <br/> I create modern,
                    responsive websites using React.js, Tailwind CSS, and
                    JavaScript. I focus on clean design, performance, and a
